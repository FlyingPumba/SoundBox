...
public class PlayListsActivity extends ListActivity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
		        ...
		        b.putStringArrayList("songs", new ArrayList<String>(sh.getSongsFromPlayList(playlistID)));
	    ...
	    setListAdapter(new ArrayAdapter<String>(this,
	            android.R.layout.simple_list_item_1, SongEntry.getValuesList(playLists)));
	...
	protected void onListItemClick(ListView l, View v, int position, long id) 
    {
        super.onListItemClick(l, v, position, id);
	     ...
	     //mostramos las canciones de esa lista de reproduccion llamando al SongsListActivity
        
        //Creamos el Intent
        PlayActivityIntent = new Intent();
        PlayActivityIntent.setAction("com.arcusapp.arcusmusic.SONGSLIST_ACTIVITY");
